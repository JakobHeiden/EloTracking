...
public class DiscordBotService {
	...
	public final ReactionEmoji arrowUp = ReactionEmoji.codepoints("U+2B06");
	public final ReactionEmoji arrowDown = ReactionEmoji.codepoints("U+2B07");
	public final ReactionEmoji leftRightArrow = ReactionEmoji.codepoints("U+2194");
	...
	public DiscordBotService(GatewayDiscordClient gatewayDiscordClient, EloTrackingService service, @Lazy CommandParser commandParser,
		...
		client.on(ReactionAddEvent.class)
				...
				.map(event -> new EventWrapper(event, service, this, queue))
				.map(CommandParser::setCommandStringForReactionAddEvent)
